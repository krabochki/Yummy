...
На данный момент Yummy использует базу данных Supabase и не является полноценной социальной сетью, а лишь презентацией будущего концепта и проделанной работы, поэтому впереди еще релиз полноценного бэкенда.
...
- База данных: Supabase (на данный момент)
