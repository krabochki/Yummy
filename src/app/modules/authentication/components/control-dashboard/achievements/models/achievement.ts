...
export const loadingAchievement: IAchievement = {
  ...
  description: 'Achievement will be load soon',
  kind: '',
  points: 0,
  iconUrl: '',
  color:''
...
export const achievementDescriptions: { [key: string]: string } = {
  ...
  ingredients:
    'Количество публичных ингредиентов, которые добавил пользователь',
  categories: 'Количество публичных категорий, которые добавил пользователь',
  'public-recipes':
    'Количество публичных рецептов, которые добавил пользователь',
  'private-recipes':
    'Количество приватных рецептов, которые добавил пользователь',
  'all-your-planned':
    'Количество планов, составленных со всеми рецептами пользователя другими кулинарами',
  'all-your-favs':
    'Количество добавлений в избранное всех рецептов пользователя',
  'you-like':
    'Количество лайков, которые поставил пользователь на рецепты других кулинаров',
