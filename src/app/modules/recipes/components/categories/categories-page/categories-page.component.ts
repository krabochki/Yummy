...
export class CategoriesPageComponent implements OnInit, OnDestroy {
  ...
  getCategoriesData() {
    ...
    this.getPopularCategories().subscribe(
      () => {
    ...
    if (this.loaded) {
      ...
      this.sectionService
        ...
        .subscribe((response: any) => {
          ...
          actualSections.forEach((section) => {
            categoriesSubscribes.push(
              this.categoryService
                .getCategoriesOfSection(section.id)
                .pipe(
          ...
          categoriesSubscribes =categoriesSubscribes.length ? categoriesSubscribes : of(null)
  ...
  createCategoryButtonClick() {
    if (!(this.categories.length === 0 && !this.loaded) && !this.initialLoading)
