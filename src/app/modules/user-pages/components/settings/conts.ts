...
export const stepsIcons: string[] = ['home','person','notifies','preferences','control'] 
export const steps:string[] = ['Основное', 'Персональная информация','Уведомления','Предпочтения','Управление']